...
<div class="min-h-screen flex" :style="theme === 'light' ? 'background:var(--bg-page)' : 'background:#000'">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
        ...
        <nav style="padding:16px 0;flex:1;">
            ...
            <a href="{{ route('service-packages.index') }}"
               class="nav-item {{ request()->routeIs('service-packages.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <div class="flex-1 flex flex-col min-w-0" style="overflow:hidden;">
        ...
        {{-- Top Bar --}}
        <header style="border-bottom:1px solid var(--border);padding:14px 24px;display:flex;align-items:center;gap:12px;position:sticky;top:0;z-index:10;">
            {{-- Hamburger --}}
