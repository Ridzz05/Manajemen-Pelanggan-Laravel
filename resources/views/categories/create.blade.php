...
<div style="max-width:500px;">
    <div class="nb-card">
        <div class="nb-card-header" style="background:#000;color:#FFDD00;">
            <span style="font-size:11px;letter-spacing:0.12em;font-family:'Space Mono',monospace;text-transform:uppercase;">form.kategori.baru</span>
        </div>
        <form action="{{ route('categories.store') }}" method="POST" style="padding:24px;display:flex;flex-direction:column;gap:18px;">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" required style="width:100%;padding:10px 14px;font-size:13px;">
            ...
            <div style="display:flex;align-items:center;gap:10px;">
                <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} style="width:18px;height:18px;accent-color:#000;cursor:pointer;">
            ...
            <div style="display:flex;gap:12px;margin-top:10px;padding-top:18px;border-top:2px solid #000;">
                ...
                <button type="submit" class="btn-nb btn-primary" style="flex:1;justify-content:center;">Simpan</button>
            </div>
        </form>
    </div>
</div>
